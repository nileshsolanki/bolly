...
public class MovieGenreAdapter extends RecyclerView.Adapter<MovieGenreAdapter.GenreViewHolder> {
    ...
    public static final Integer [] genreIds = new Integer[] { 28, 12, 16, 35, 80, 99, 18, 10751, 14, 36, 27, 10402, 9648, 10749, 878, 53, 10770, 10752, 37};
    int [] genreDrawables = new int[] {R.drawable.action, R.drawable.adventure, R.drawable.animation, R.drawable.comedy, R.drawable.crime,
                    R.drawable.documentary, R.drawable.drama, R.drawable.documentary, R.drawable.fantasy, R.drawable.history, R.drawable.documentary, R.drawable.musical,
                    R.drawable.mystery, R.drawable.romance, R.drawable.science_fiction, R.drawable.thriller, R.drawable.tv_movie, R.drawable.war, R.drawable.western};
